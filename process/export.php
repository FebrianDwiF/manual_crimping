...
switch ($dataType) {
    ...
    case 'lko':
        ...
        $columns = ['id','Carline', 'Mesin', 'Time', 'Shift', 'No Issue', 'Scan Kanban', 'Qty', 'Kind', 'Size', 'Col', 'Terminal', 'Lot Terminal', 'F_C_H', 'R_C_H', 'F_C_W', 'R_C_W', 'C_L', 'Kode Defect', 'Qty M', 'Code Error', 'Downtime','created_at'];
        break;
    default:
